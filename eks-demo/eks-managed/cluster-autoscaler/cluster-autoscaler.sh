...
eksctl create iamserviceaccount --name cluster-autoscaler --region ${region} --namespace kube-system --region ${region} --cluster ${eks_cluster_name} --attach-policy-arn ${policy_arn} --approve  --override-existing-serviceaccounts
